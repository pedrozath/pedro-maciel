...
(function() {
  var $invisible_el, $visible_el, animations, circular_random, duration;
  ...
  window.Delay = (function() {
    ...
    Delay.prototype.add_duration = function(d) {
      this.last_duration = d;
      return this.delay += d;
    };

    Delay.subtract = function(d) {
      this.instance.delay -= d;
      return this;
    };

    Delay.delay = function() {
      var output;
      output = this.instance.delay - this.instance.last_duration;
      this.instance.last_duration = 0;
      return output;
    };

    Delay.add_stagger_duration = function(length, d, overlap) {
      var stagger;
      stagger = d * overlap;
      this.add_duration(stagger * length);
      this.instance.last_stagger = stagger;
      return d;
    };

    Delay.last_stagger = function() {
      return this.instance.last_stagger;
    };

    Delay.add_duration = function(d) {
      this.instance.add_duration(d);
      return d;
    };
  ...
  $visible_el = function(selector) {
    var window_height;
    window_height = $(window).height();
    return $(selector).filter(function() {
      return $(this).offset().top < window_height;
    });
  };

  $invisible_el = function(selector) {
    var window_height;
    window_height = $(window).height();
    return $(selector).filter(function() {
      return $(this).offset().top > window_height;
  ...
  animations = (function(_this) {
    return function() {
      var $tech_section, black, light_gray, logo_center, purple, space_gray, white, yellow;
      black = '#000000';
      white = '#FFFFFF';
      yellow = '#FFF030';
      space_gray = '#121212';
      ...
      return {
        'pages#index': function() {
          var index, square, x, y;
          return new TimelineMax({
            paused: true,
            align: 'normal',
            tweens: [].concat(TweenMax.fromTo($('footer'), duration(1000), {
              x: '0%',
              opacity: 1
            }, {
              x: '100%',
              ...
              ease: Cubic.easeInOut,
              delay: duration(300)
            }, duration(120)), TweenMax.fromTo($('main > nav.main'), duration(700), {
              width: '100%'
            }, {
              width: '0%',
              ease: Cubic.easeInOut,
              ...
              delay: duration(1800)
            }, duration(15)), (function() {
              var i, len, ref, ref1, results;
              ref = $('.tagline .square').get().reverse();
              results = [];
              for (index = i = 0, len = ref.length; i < len; index = ++i) {
                square = ref[index];
                ref1 = circular_random(200), x = ref1.x, y = ref1.y;
                results.push(TweenMax.staggerFromTo($(square), duration(500), {
                  x: 0,
                  y: 0
                }, {
                  x: x,
              ...
              delay: duration(3500),
              ease: Cubic.easeInOut
            }, duration(6)), TweenMax.staggerFromTo($('body'), duration(1000), {
              ...
              fill: black,
              delay: duration(4000)
            }, 0), TweenMax.staggerFromTo($('body > header'), duration(1500), {
              width: '100%'
            }, {
              width: '0%',
              delay: duration(4000),
              ease: Cubic.easeInOut
            }, 0), TweenMax.staggerFromTo($('.logo'), duration(1000), {
              x: 0,
              y: 0
            }, {
              x: logo_center.x,
        ...
        'portfolio#index': function() {
          return new TimelineMax({
            paused: true,
            align: 'normal',
            tweens: [].concat(TweenMax.staggerFromTo($('nav.main a').get().reverse(), duration(300), {
              top: 0,
              opacity: 1
            }, {
              top: -24,
              ...
              ease: Cubic.easeInOut,
              delay: duration(0)
            }, duration(250)), TweenMax.fromTo($('nav.main'), duration(400), {
              width: '100%'
            }, {
              width: '0%',
              ease: Cubic.easeInOut,
              ...
              opacity: 0
            }, duration(0)), TweenMax.staggerFromTo($visible_el('.jobs li').get().reverse(), duration(210), {
              opacity: 1,
              transformOrigin: '0 0',
              z: 0
            }, {
              ...
              ease: Cubic.easeInOut,
              z: 60
            }, duration(100)), TweenMax.staggerFromTo($('nav.left-column ul li').get().reverse(), duration(150), {
              z: 0,
              opacity: 1
            }, {
              z: 100,
              ...
              ease: Cubic.easeInOut,
              delay: duration(900)
            }, duration(20)), TweenMax.staggerFromTo($('.header-sandwich .bar .h2'), duration(300), {
              x: '0%'
            }, {
              x: '-100%',
              ease: Cubic.easeInOut,
              delay: duration(1300)
            }, duration(400)), TweenMax.staggerFromTo($('.left-column').get().reverse(), duration(400), {
              width: 288
            }, {
              width: 0,
              ease: Cubic.easeInOut,
              delay: duration(1600)
            }, duration(100)), TweenMax.fromTo($('.logo'), duration(1000), {
              x: 0,
              y: 0
            }, {
              x: logo_center.x,
        ...
        'portfolio#show': function() {
          var index, section, t, tweens, x, y;
          return new TimelineMax({
            paused: true,
            align: 'normal',
            tweens: [].concat(TweenMax.fromTo($('body > footer'), Delay.reset().add_duration(0.6), {
              opacity: 1
            }, {
              opacity: 0,
              ease: Cubic.easeInOut,
              ...
              ease: Cubic.easeInOut,
              delay: Delay.subtract(0.4).delay()
            }, Delay.last_stagger()), TweenMax.fromTo($('.job-content footer > h2'), Delay.add_duration(0.6), {
              opacity: 1,
              y: '0%'
            }, {
              opacity: 0,
              ...
              var i, len, ref, ref1, results;
              ref = $('.job-content .technologies li');
              results = [];
              for (index = i = 0, len = ref.length; i < len; index = ++i) {
                t = ref[index];
                ref1 = circular_random(100), x = ref1.x, y = ref1.y;
                results.push(TweenMax.fromTo(t, Delay.add_duration(0.7), {
                  y: 0,
                  x: 0
                }, {
                  y: x,
                  x: y,
                  ease: Cubic.easeInOut,
                  delay: (index === 0 ? Delay.delay() : Delay.subtract(0.7).delay())
                }));
              }
              return results;
              ...
              ref = $('.job-content section').not($tech_section).get().reverse();
              results = [];
              for (index = i = 0, len = ref.length; i < len; index = ++i) {
                section = ref[index];
                tweens = [];
              ...
              ease: Cubic.easeInOut,
              delay: Delay.subtract(0.2).delay()
            }, Delay.last_stagger()), TweenMax.fromTo($('nav.main'), Delay.add_duration(0.4), {
              width: '100%'
            }, {
              width: '0%',
              ease: Cubic.easeInOut,
...
(function() {
  this.Presentation = (function() {
    ...
    Presentation.prototype.make_playable = function() {
      this.$play_btn.removeClass('disabled').addClass('live').text('Watch my Introduction');
...
(function() {
  ...
  this.App = (function() {
    App.prototype.callbacks = {
      'after_load:pages#index': [
        new Callback('after_load:pages#index', function() {
          return App.presentation = new Presentation({
      ...
      'leave:pages#index': [
        new Callback('after_leave:pages#index', function() {
          return App.presentation.destroy();
        })
      ]
    };
    ...
    App.prototype.load_state = function(route_object, callback) {
      this.run_callbacks("leave:" + this.current_state);
      this.start_loading();
    ...
    App.prototype.scroll_up = function(callback) {
    ...
    App.prototype.change_state = function(route_object) {
      ...
      if (state !== this.current_state) {
        ...
        return this.scroll_up((function(_this) {
          return function() {
